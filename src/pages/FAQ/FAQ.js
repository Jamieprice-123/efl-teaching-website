...
const FAQ = () => {
            ...
            questions: [
                {
                    ...
                    answer: 'Single lessons are £25/hour. I offer package discounts: 5-lesson pack for £118.75 (5% off) and 10-lesson pack for £225 (10% off). Packages secure your preferred times and provide better value. NB: these are the prices in GBP - the amount to pay in your currency will converted from this.'
                },
                {
                    question: 'How much do group classes cost?',
                    answer: 'Group classes vary by duration: 1 month intensive (£240), 3 months from £342 (5% discount), and 9 months for £972 (10% discount). All prices are per student for the complete course. NB: these are the prices in GBP - the amount to pay in your currency will converted from this.'
                },
                {
    ...
    return (
        <div className="faq">
                ...
                <div className="container">
                    ...
                    >
                        ...
                        <p className="faq-subtitle">
                            Find answers to common questions about my teaching services
                        </p>
                        <p className="faq-description">
                            Can't find what you're looking for? Feel free to <Link to="/contact">contact me</Link> directly!
                        </p>
                    </motion.div>
                </div>
            </section>
            ...
            <section className="faq-cta section bg-primary">
                <div className="container">
                    <motion.div
                    ...
                    >
                        ...
                        <p>I'm happy to answer any questions you might have about my teaching services</p>
