          ...
          <div className="about-hero-content">
            ...
            >
              ...
              <p className="about-subtitle">
                Your dedicated English teacher with 12 years of experience and a passion for holistic language learning
              </p>
              <p className="about-description">
                Hello! I'm Rosamund Scott, but you can call me Rose. I've been teaching English as a Foreign Language 
                since I graduated 12 years ago, and I absolutely love what I do. My approach to teaching is what I call 
                'holistic language teaching' - I believe in targeting my students' interests to help them learn and 
                practice English in a way that feels natural and engaging.
              </p>
              <div className="about-location">
                📍 Based in Stockport, UK • Teaching online worldwide
              </div>
            </motion.div>
            <motion.div 
            ...
            >
              ...
              <div className="experience-highlights">
                <div className="highlight">
                  ...
                  <p>
                    I've taught almost exclusively to speakers of Spanish, Galician, and Catalan in Spain, 
                    as well as French and Portuguese speakers in Barcelona. Now I'm excited to expand 
                    my reach to students worldwide!
                  </p>
                </div>
                <div className="highlight">
        ...
        <div className="container">
          ...
          >
            <div className="usp-main">
              ...
              <p>
                This is the one thing I've never seen in the two language schools I worked in Spain, 
                and it's probably my most unique selling point. My 'project courses' involve studying 
                a specific book, podcast, or TV series as a vehicle for practicing English.
              </p>
              <p>
