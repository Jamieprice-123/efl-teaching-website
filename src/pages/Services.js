    ...
    const courseTypes = [
        {
            ...
            duration: 'Various course lengths available',
    ...
    const learningFormats = [
        {
            ...
            duration: '1-2 hours per session, various course lengths available'
        },
        {
            title: 'Group Classes',
            icon: '👥',
                ...
                <div className="container">
                    ...
                    >
                        ...
                        <p className="services-description">
                            ...
                            I offer a range of course types designed to make learning English engaging, effective, and enjoyable.
                        </p>
                    </motion.div>
                </div>
            </section>
            ...
            <section className="services-grid-section section">
                <div className="container">
                    <div className="section-title">
                        <h2>What I Offer</h2>
                        <p>Choose the course type that matches your learning goals</p>
                    </div>
                    <div className="services-grid">
                        {courseTypes.map((service, index) => (
                            <motion.div
                                key={index}
                    ...
                    <div className="format-note">
                        <p>{content.services.formatNote}</p>
                    </div>
                </div>
            </section>

            <section className="learning-format section bg-light">
                <div className="container">
                    <div className="section-title">
                        <h2>Learning Format</h2>
                        <p>Choose how you want to learn - individually or in a group</p>
                    </div>
            ...
            <section className="consultation-section section">
                <div className="container">
                    ...
                    >
                        ...
                        <p>
                            Not sure which course type is right for you? I offer a free 20-minute consultation
                        ...
                        <div className="consultation-feature">
                            ...
                            <p>Get personalized course type recommendations</p>
                        </div>
                </div>
    ...
    <section className="services-cta section">
        <div className="container">
            ...
            >
                ...
                <p>
                    Choose the course type that best fits your needs and goals.
